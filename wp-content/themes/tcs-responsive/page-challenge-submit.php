            ...
            <form action="http://studio.topcoder.com/" method="POST" name="submitForm" enctype="multipart/form-data" id="submitForm" autocomplete="off">
                <section class="formSection browseFile">
                    ...
                    <div class="rightCol col">
                        ...
                        <p>If you experience issues uploading large files, please email your submission to <a href="mailto:support@topcoder.com">support@topcoder.com</a> along with a link to this page.</p>
                        <p>We apologize for this inconvenience and working to resolve the issue.</p>
                    </div>
                    <div class="clear"></div>
                </section>
